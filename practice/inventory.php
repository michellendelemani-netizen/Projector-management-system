        ...
        if ($result->num_rows > 0){
            while($row = $result->fetch_assoc()){
                echo "<tr>
                    ...
                    <td>
                        <a href='suspend.php?id={$row['projector_id']}'><button type='button' class='sus'>Suspend</button></a>
                         <a href='delete.php?id={$row['projector_id']}'><button type='button'class='rem'>remove</button></a>
                    </td>
                </tr>";
            } 
        }else{
